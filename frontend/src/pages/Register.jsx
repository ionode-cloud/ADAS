...
const Register = () => {
    ...
    const handleRegister = async (e) => {
        ...
        setLoading(true);
        try {
            await axios.post('http://localhost:5000/api/auth/register', { email, password, role: 'user' });
            setStep(STEPS.OTP);
            setCountdown(60);
        } catch (err) {
    ...
    const handleVerifyOtp = async (e) => {
        ...
        setLoading(true);
        try {
            await axios.post('http://localhost:5000/api/auth/verify-otp', { email, otp: code });
            setStep(STEPS.DONE);
        } catch (err) {
