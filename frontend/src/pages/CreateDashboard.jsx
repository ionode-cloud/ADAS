...
import {
    ...
    MapPin, FileSpreadsheet, Download, MonitorCheck, Radio,
...
const FEATURES = [
    ...
    { key: 'dataLogging', label: 'XLS Data Logging', icon: FileSpreadsheet, color: '#8B5CF6', desc: 'Log telemetry to spreadsheet' },
    { key: 'dataDownload', label: 'Data Download', icon: Download, color: '#EC4899', desc: 'Export & download records' },
    { key: 'deviceList', label: 'Device Online/Offline', icon: MonitorCheck, color: '#38BDF8', desc: 'Live device status checker' },
    { key: 'ota', label: 'ESP32 OTA Update', icon: Radio, color: '#A78BFA', desc: 'Over-the-air firmware update' },
];
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await axios.post(
                ...
                { dashboardName, deviceId, enabledFeatures, description },
    ...
    return (
        <div className="h-full flex flex-col slide-in">
            ...
            <div className="mb-8">
                ...
                <p className="text-slate-500 mt-1 ml-1">Configure features and link an ESP32 device to your monitoring interface</p>
            </div>
                        ...
                        <div className="cd-card">
                            ...
                            <div className="flex flex-col gap-4">
                                <div className="cd-field-group">
                                    <label className="cd-label">Device ID</label>
                                    <input
                                        type="text"
                                    ...
                                    <p className="cd-hint flex items-center gap-1">
                                        <Sparkles size={11} /> A unique Particle ID will be auto-generated for your ESP32
                                    </p>
                                </div>
